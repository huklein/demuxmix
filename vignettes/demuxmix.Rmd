...
most likely class is smaller than *pAcpt*, the cell is classified as
...
the FDR depending on the current setting of *pAcpt*.
...
scatter plot shows that a smaller set of cells has a lower RNA content (y axis)
